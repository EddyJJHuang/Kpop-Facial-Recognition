...
def face_detect_demo(img):
    ...
    face=face_detector.detectMultiScale(gray,1.1,5,cv2.CASCADE_SCALE_IMAGE,(50,50),(500,500))
    ...
    for x,y,w,h in face:
        ...
        if confidence >80:
            cv2.putText(img,'unknow', (x+10,y-10),cv2.FONT_HERSHEY_SIMPLEX,0.75,(255,255,0),3)
        else:
